...
<div id="vi_wpb_popup_email" style="display: none">
	...
	<div class="vi-wpb_popup">
		<div class="woopb-title"><?php esc_html_e( 'Send email to your friend', 'woo-product-builder' ) ?></div>
		...
		<div class="content">
			<form action="" method="post" class="vi-wpb_send_email">
				...
				<div class="woopb-row">
					<label><?php esc_html_e( 'To', 'woo-product-builder' ) ?></label>
				...
				<div class="woopb-row">
					<label><?php esc_html_e( 'Subject', 'woo-product-builder' ) ?></label>
				...
				<div class="woopb-row woopb-full-width">
					<label><?php esc_html_e( 'Message', 'woo-product-builder' ) ?></label>
				...
				<div class="woopb-row">
					<button class="vi-wpb_review_btn vi-wpb_addtocart_btn woopb-button">
						<?php esc_html_e( 'Send', 'woo-product-builder' ) ?>
					</button>
				</div>
			</form>
