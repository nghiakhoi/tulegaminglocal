...
$rocket_cookie_hash = 'ae91b5d6c2eec29b62427f4e90387f37';
$rocket_logged_in_cookie = 'wordpress_logged_in_ae91b5d6c2eec29b62427f4e90387f37';
$rocket_cache_mobile_files_tablet = 'desktop';
$rocket_cache_mobile = 1;
$rocket_cache_reject_uri = '/(.+/)?feed/?.+/?|/(?:.+/)?embed/|/checkout/(.*)|/cart/|/tai-khoan/(.*)|/wc-api/v(.*)|/(index\.php/)?wp\-json(/.*|$)';
...
$rocket_secret_cache_key = '5fbbb33438b6c877672462';
$rocket_cache_ssl = 1;
